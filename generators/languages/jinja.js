/**
 * Jinja Language Code Base Generator
 * Generates Jinja template code base/boilerplate code
 */

/**
 * Generates Jinja code base
 * @returns {string} Jinja template code base template
 */
function generateJinjaCodeBase() {
    return `
