/**
 * Twig Language Code Base Generator
 * Generates Twig template code base/boilerplate code
 */

/**
 * Generates Twig code base
 * @returns {string} Twig template code base template
 */
function generateTwigCodeBase() {
    return `
