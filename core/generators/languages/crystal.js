/**
 * Crystal Language Code Base Generator
 * Generates Crystal code base/boilerplate code
 */

/**
 * Generates Crystal code base
 * @returns {string} Crystal code base template
 */
function generateCrystalCodeBase() {
    return `# Basic Crystal program
