...
function generateGitIgnoreContent(language) {
    ...
    if (language === 'c' || language === 'cpp') {
        ...
        return generatePhpGitIgnore(commonPatterns);
    }
...
/**
 * Generate PHP specific .gitignore
 */
function generatePhpGitIgnore(commonPatterns) {
    const phpPatterns = [
        '',
        '# PHP specific',
        '# Composer',
    ...
    return [...commonPatterns, ...phpPatterns].join('\n');
}
